...
`
                ...
                {
                    role: 'system', content: `1. 그녀는 최근에 심각한 병을 진단받았다.
                    2. 방 안의 물건들은 그녀가 과거에 누렸던 행복한 시간을 상기시켰다.
                    3. 그녀는 자신이 떠난 후에도 이곳이 남아 있을 것을 알고 안심했다.`
                },
                {
                    role: 'user', content: `문제를 다시 만들어줘`
                },
...
`
                ...
                {
                    role: 'system', content: `1. 그녀는 최근에 큰 사고를 당해 얼굴에 큰 흉터가 생겼다.
                    2. 그녀는 거울을 볼 때마다 사고 당시의 기억이 떠올랐다.
                    3. 그녀는 이전의 모습을 다시 볼 수 없다는 사실을 받아들이기 힘들었다.`
                },
                {
                    role: 'user', content: `문제를 다시 만들어줘`
                },
...
`
                ...
                {
                    role: 'system', content: `1. 그 남자는 과거에 강도에게 공격당한 경험이 있었다.
                    2. 그의 아내는 남자가 잠든 후에 외출하는 비밀스러운 습관이 있었다.
                    3. 그 밤, 그의 아내는 누군가에게 납치되었다.
`
                },
                {
                    role: 'user', content: `문제를 다시 만들어줘`
...
`
                ...
                {
                    role: 'system', content: `1. 그녀는 최근에 남편을 잃었다.
                    2. 남편은 생전에 모든 청구서를 처리하는 역할을 맡았었다.
                    3. 청구서의 발신인은 남편의 이름으로 되어 있었다.`
                },
                {
